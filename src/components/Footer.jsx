      ...
      <div className="relative z-10 container mx-auto px-4 py-8 sm:py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-6">
          ...
          <div className="space-y-4 md:col-span-1 lg:col-span-1">
            <h3 className="text-lg text-[#DEA944] font-semibold text-center md:text-left mb-4">Contact Us</h3>
            ...
            <div className="flex items-start space-x-3 justify-center md:justify-start mt-4">
              ...
              <div className="text-gray-300 text-sm text-center md:text-left">
                <p className="font-medium">HENZA GOLD & JEWELLERY TRADING LLC</p>
          ...
          <div className="md:col-span-2 lg:col-span-1">
            <h3 className="text-lg text-[#DEA944] font-semibold text-center md:text-left mb-4">Quick Links</h3>
            <nav className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-1 gap-2 font-normal">
              <a href="#home" className="text-gray-300 hover:text-yellow-400 transition-colors text-center md:text-left py-1">Home</a>
              <a href="#benefits" className="text-gray-300 hover:text-yellow-400 transition-colors text-center md:text-left py-1">Benefits</a>
              <a href="#about" className="text-gray-300 hover:text-yellow-400 transition-colors text-center md:text-left py-1">About us</a>
              <a href="#product" className="text-gray-300 hover:text-yellow-400 transition-colors text-center md:text-left py-1">Product</a>
            </nav>
          </div>
          
          {/* Social Profiles */}
          <div className="space-y-4 lg:col-span-1">
            <h3 className="text-lg text-[#DEA944] font-semibold text-center md:text-left">Follow Us</h3>
            <div className="flex justify-center md:justify-start space-x-4">
              <a href="#" className="w-10 h-10 bg-white text-yellow-600 rounded-lg flex items-center justify-center hover:bg-yellow-600 hover:text-white transition-all transform hover:scale-110 shadow-lg">
